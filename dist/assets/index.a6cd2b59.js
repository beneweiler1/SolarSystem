import{S as L,P as R,W as b,a as q,A,T as m,F as _,b as u,M as s,c as i,d as I,e as l,f as p,g as P}from"./vendor.bf2d2062.js";const J=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))B(r);new MutationObserver(r=>{for(const c of r)if(c.type==="childList")for(const j of c.addedNodes)j.tagName==="LINK"&&j.rel==="modulepreload"&&B(j)}).observe(document,{childList:!0,subtree:!0});function n(r){const c={};return r.integrity&&(c.integrity=r.integrity),r.referrerpolicy&&(c.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?c.credentials="include":r.crossorigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function B(r){if(r.ep)return;r.ep=!0;const c=n(r);fetch(r.href,c)}};J();const e=new L,a=new R(40,window.innerWidth/window.innerHeight,.1,2e3),f=new b({canvas:document.querySelector("#bg")});f.setPixelRatio(window.devicePixelRatio);f.setSize(window.innerWidth,window.innerHeight);a.position.setZ(4900);f.render(e,a);const N=new q(16777215),W=new A(16777215);N.position.set(0,0,50);e.add(W);document.addEventListener("mousewheel",o=>{a.position.z+=o.deltaY/100});document.addEventListener("keypress",o=>{o.key=="w"&&(a.position.z-=1),o.key=="s"&&(a.position.z+=1),o.key=="a"&&(a.position.z+=10),o.key=="d"&&(a.position.z-=10)});const U=new m().load("images/sun.jpg"),O=new m().load("images/Mercury.jpg"),G=new m().load("images/venus.jpg"),H=new m().load("images/Earth.jpg"),C=new m().load("images/moon.jpg"),V=new m().load("images/mars.png"),D=new m().load("images/Jupiter.jpg"),K=new m().load("images/Saturn.jpg"),Y=new m().load("images/Uranus.jpg"),Z=new m().load("images/Neptune.jpg"),w=new m().load("images/normal.jpg"),d=new _;d.load("fonts/SquareFont_Regular.json",function(o){const t=new u(`Move 1,000,000 km forward with "w" and backward with "s" 
 move 10,000,000 km forward with "d" and backward with "a"`,{font:o,size:8,height:2}),n=new s(t,[new i({color:16711935}),new i({color:15})]);n.castShadow=!0,n.position.z=4630,n.position.x=-160,n.position.y=-70,e.add(n)});d.load("fonts/StarJedi Special Edition_Regular.json",function(o){const t=new u(`Welcome to our Solar System 
   Created by Ben Weiler`,{font:o,size:11,height:4}),n=new s(t,[new i({color:16711935}),new i({color:0})]);n.castShadow=!0,n.position.z=4660,n.position.x=-130,n.position.y=60,e.add(n)});d.load("fonts/StarJedi Special Edition_Regular.json",function(o){const t=new u("The End",{font:o,size:.8,height:4}),n=new s(t,[new i({color:16711935}),new i({color:0})]);n.castShadow=!0,n.position.z=-80,n.position.x=-2,n.position.y=0,e.add(n)});var Q=new I(15,.8,100,2999);const h=new s(Q,new l({color:8421504,wireframe:!0}));e.add(h);h.position.z=3075;h.rotation.y=-.1;h.rotation.x=30;const g=new s(new p(50,32,32),new l({map:U,normalMap:w}));e.add(g);g.position.z=4500;d.load("fonts/SquareFont_Regular.json",function(o){const t=new u(` Sun 
